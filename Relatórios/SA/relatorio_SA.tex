...
%
\authorrunning{C. Bergueira, F. Pereira, D. Silva, R. Rodrigues}
...
Bouchabou, D., Nguyen, S.M., Lohr, C., LeDuc, B., Kanellos, I.: A Survey of Human Activity Recognition in Smart Homes Based on IoT Sensors Algorithms. Sensors 21(18), 6037 (2021).
...
Paraschiakos, S. et al.: Activity recognition using wearable sensors for tracking the elderly. User Model. User-Adapt. Interact. 30, 567-605 (2020).
