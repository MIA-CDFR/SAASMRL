...
# sensor_agent_name = "sensor_agent"
...
# async def run():
#     sensor_agent = SensorAgent(f"{sensor_agent_name}@localhost", "password")
#     await _start_agent(sensor_agent)

#     print("Agente iniciado")

#     # ligar agente ao server
#     server.sensor_agent = sensor_agent
#     server.sensor_agent_jid = f"{sensor_agent_name}@localhost"

#     # iniciar Flask numa thread separada
